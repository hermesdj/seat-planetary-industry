        ...
        <div class="card-body">
            <table class="table datatable table-sm table-condensed table-striped table-hover">
                ...
                @foreach($characters as $character)
                    @foreach($character->piColonies as $colony)
                        @foreach($colony->extractors as $extractor)
                            <tr>
                                ...
                                <td>
                                    @foreach($colony->groupedContents() as $content)
                                        @include('web::partials.type', ['type_id' => $content->product->typeID, 'type_name' => $content->product->typeName])
                                        {{number_format($content->amount)}}
                                    @endforeach
                                </td>
                            </tr>
                        @endforeach
